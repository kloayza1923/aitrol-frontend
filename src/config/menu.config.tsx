    ...
    children: [
      {
        ...
        path: '/puerto-management'
      },
      {
        title: 'Crear puerto',
        path: '/puerto-management-add'
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        path: '/materiales-management-add'
      },
      {
        title: 'Lista de Materiales',
        path: '/materiales-management'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        title: 'Crear puntos',
        icon: 'star',
        path: '/points-management/add-points'
      }
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            title: 'Lista de Roles de Pago',
            icon: 'money',
            path: '/rhrol-management'
          },
          {
            title: 'Crear Rol de Pago',
            icon: 'money',
            path: '/rhrol-management/create'
          }
        ]
      },
      {
...
//console.log(menuDataFromDB);
export const MENU_SIDEBAR: TMenuConfig = menu_default;
