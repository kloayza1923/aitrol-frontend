...
// Importa todos los icons que quieras usar
import {
  Home,
  Settings,
  Info,
...
// Lista de iconos con su nombre y componente
const iconOptions = [
...
const CreateMenu = () => {
  ...
  return (
    <Container>
      ...
      <Autocomplete
        options={menus}
        getOptionLabel={(option) => option.title + ' (Menu-' + option.parent_name + ')'}
